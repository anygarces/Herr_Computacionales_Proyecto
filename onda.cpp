...
int main() {
    ...
    ofstream outfile("wave_data.txt");
    if(!outfile.is_open()) {
        cerr << "No se pudo abrir 'wave_data.txt' para escritura.\n";
        return -1;
    }
    ...
    outfile.close();
    cout << "Simulacion finalizada. Datos guardados en 'wave_data.txt'.\n";
    return 0;
}
