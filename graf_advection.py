...
# Extracción de datos
data = np.genfromtxt("D:\Sebastian\Documents\VSCode\Herramientas Computacionales\Proyecto\Herr_Computacionales_Proyecto\Project_Final\datos_simulacionA.txt", 
                     delimiter=" ",
                     skip_header=1)
